...
def fetch_model_config(model_id: str):
    """
    Downloads config.json for a given HF model id (e.g. "bert-base-uncased")
    and extracts the fields we need for memory estimation.
    """
    try:
    ...
    if hidden_size is None or num_layers is None:
        raise ValueError(
            ...
            f"This model architecture may use non-standard field names — "
